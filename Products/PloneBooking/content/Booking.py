...
class Booking(BaseContent):
    ...
    def post_validate(self, REQUEST, errors):
        ...
        if booking_brains:
            ...
            msg = _("message_date_already_booked",
                    default=u"An object is already booked at this date/timeslot.",
                    domain='plonebooking',
                    context=self)
    ...
    def updateBooking(self, REQUEST):
        ...
        fieldsToValidate = ['fullName', 'phone', 'email', 'title']
